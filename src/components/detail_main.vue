            ...
            <div class="content-font">
              <div class="am-cf author-panel">
                <div class="author am-fl">
                  <a :href="detail.author_href" class="am-fl">
                    <span class="name">{{detail.author_title}}</span>
                  </a>
                  <span class="time am-fl">
                    <span class="dot">&nbsp;•&nbsp;</span>
                    <abbr class="time">{{detail.time|mktime}}</abbr>
                  </span>
                  <span class="time am-fl">
                    <span class="dot">&nbsp;•&nbsp;</span>
                    <abbr class="time">{{detail.tag}}</abbr>
                  </span>
                </div>
              </div>
              <section class="summary">{{detail.summary}}</section>
              <div>
                <section class="textblock" v-if="detail.article" v-html="detail.article['detailArticle|post'].content">
                </section>
              ...
              <section class="single-post-tags">
                <a
                  ...
                  :href="json.href"
                  target="_blank"
                  v-for="(json,index) in detail.catalogs"
                  :key="index"
                >{{json.name}}</a>
              </section>
                ...
                <div class="inner fixed" style="width: 720px;">
                  <div class="box am-cf">
                    <div class="share-author am-cf am-fl">
                      <a href="/user/375349">
                        <img class="avatar" src="static/img/head_50.jpg" alt />
              ...
              <div class="h5-author-info am-cf">
                <div class="img-box am-fl">
                  <a href="/user/375349" target="_blank">
                    <img src="static/img/head_50.jpg" />
                  </a>
                </div>
                <div class="info">
                  <p class="name">
                ...
                <div class="textarea-wrapper">
                  ...
                  <div class="user">
                    ...
                    <div class="current-user">
                      <span
                        class="img"
                        style="background: url(static/img/f3a5016d8jzc4auz.png) center center / 80% no-repeat rgb(241, 241, 241);"
                      ></span>
              ...
              <div class="each-cell am-cf">
                <div class="img-box">
                  <a
                    ...
                    target="_blank"
                    style="background-image: url(static/img/t1.jpg);"
                  ></a>
                </div>
                <div class="info">
                  <p class="name">
...
<script>
import comments from "@/libs/comment"
export default {
    name:'detail_main',
    computed :{
      detail(){
