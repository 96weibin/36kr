          ...
          <div>
            <div class="img-cover">
              <a href="#">
                ...
                <div class="img-cell" style="background-image: url(static/img/top_img1.jpg);"></div>
          ...
          <div>
            <div class="img-cover">
              <a href="#">
                ...
                <div class="img-cell" style="background-image: url(static/img/top_img2.jpg);"></div>
                <div class="article-title">
            ...
            <div>
              <div class="img-left-cover">
                <a href="/p/5127646.html">
                  <span>3</span>
                  <div class="img-cell" style="background-image: url(static/img/top_img3.jpg);"></div>
                </a>
              </div>
    ...
    <div class="biggie_word pad_inner">
      ...
      <div class="biggie_list">
        <ul>
          <li>
            <a href="#">
              <div class="biggie_photo" style="background-image: url(static/img/face1.jpg);">
              </div>
